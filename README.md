...
Золото на сайте значит ровно две вещи: заливка — «выбрано» или «главное действие в блоке», обводка — «действие среди равных». Пять кнопок броска на обычных таблицах — это одно действие с разным числом костей, и заливка на первой читалась как «жми сюда», хотя выбирают по редкости. Теперь строка золотая целиком и одинаково.
