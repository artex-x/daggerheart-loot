...
Двуязычный (RU/EN) генератор добычи для настольной ролевой игры Daggerheart. Статический сайт без сборки: 572 предмета и расходника плюс 381 единицу снаряжения, у каждого — название, описание и картинка.
...
- **Поиск** — по всем 953 записям сразу, по названиям, описаниям и характеристикам, на обоих языках
...
img/*.webp                  742 картинки, 640×640, ~27 МБ
og/*.jpg                    те же картинки в JPEG для превью ссылок, ~39 МБ
i/*.html                    953 страницы-заглушки с Open Graph
data.json                   те же данные простым JSON, для чтения извне
catalog.csv                 953 строки, по одной на запись, с характеристиками
