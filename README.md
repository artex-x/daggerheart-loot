...
Рядом с заголовком каждого раздела есть кнопка копирования такой ссылки, а для таблиц без разделов — кнопка рядом с переключателем вида.
...
2. Нажмите **Собирать сюда** — под шапкой появится зелёная полоса с названием списка и счётчиком.
...
Открывший её видит список и может сохранить копию себе.
...
Чтобы не потерять список, есть два пути: **Поделиться** (весь состав внутри ссылки) и **Скопировать id** (строка вида `ci2,cc48,cm81`, из которой список можно собрать заново).
