...
У каждой позиции есть необязательные **количество** и **цена в золоте**. Если они заданы, то попадают и в интерфейс, и в скопированный текст: `Камень Доблести ×2 — 50 зол.`, а внизу списка считается итоговая сумма.
