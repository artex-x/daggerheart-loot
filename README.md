...
Корник и Hope & Fear — это один и тот же бросок Nd12 по таблице 1–60, поэтому они собраны в один режим. **Источник** — мультивыбор: по умолчанию отмечены обе книги, любую можно снять, но хотя бы одна должна остаться.
