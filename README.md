...
Двуязычный (RU/EN) генератор добычи для настольной ролевой игры Daggerheart. Статический сайт без сборки: 449 предметов и расходников плюс 381 единицу снаряжения, у каждого — название, описание и картинка.
...
- **Поиск** — по всем 830 записям сразу, по названиям, описаниям и характеристикам, на обоих языках
...
img/*.webp                  623 картинки, 640×640, ~23 МБ
og/*.jpg                    те же картинки в JPEG для превью ссылок, ~20 МБ
i/*.html                    830 страниц-заглушек с Open Graph
data.json                   те же данные простым JSON, для чтения извне
catalog.csv                 830 строк, по одной на запись, с характеристиками
