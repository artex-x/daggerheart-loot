...
description: A dark bilingual catalogue of 1091 Daggerheart records, with one gold accent that marks only what was chosen.
colors:
  seal-gold: "#d8ab5e"
...
one accent is rationed. The catalogue holds 1091 records in two languages, so
...
- **Tabs:** nine real links at 13.5px weight 560 in Ash Violet, each with a 2px
...
- **Don't** drift toward a neon dark mode: no saturated purple or cyan glow, no
  ...
  a short slide, and the palette's restraint is what keeps 1091 records legible.
