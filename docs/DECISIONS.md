...
- 2026-09-26 - [After the cutoff a browser list is written only by the move and a delete](decisions/2026-09-26-after-the-cutoff-a-browser-list-is-written-only-by-the-move.md)
- 2026-09-26 - [An import is one `import_lists()` transaction: every list or none](decisions/2026-09-26-an-import-is-one-import-lists-transaction.md)
...
- 2026-09-26 - [The restore drill loads the newest backup into the local stack only](decisions/2026-09-26-the-restore-drill-loads-the-newest-backup-into.md)
- 2026-09-26 - [The test build's clock is pinned before the cutoff, and `?today=` moves it](decisions/2026-09-26-the-test-builds-clock-is-pinned-before-the-cutoff.md)
...
- 2026-09-25 - [A homebrew item is stored as the catalog record shape in one jsonb column, under a per-owner `hb_` key](decisions/2026-09-25-a-homebrew-item-is-stored-as-the-catalog.md)
- 2026-09-25 - [A homebrew save is a form submit, not the account lists' optimistic queue](decisions/2026-09-25-a-homebrew-save-is-a-form-submit-not-the.md)
...
- 2026-09-25 - [Production's free-plan usage is reported nightly by its own workflow](decisions/2026-09-25-productions-free-plan-usage-is-reported-nightly-by.md)
- 2026-09-25 - [Realtime is the primary live path; the 45 s poll runs while it is down](decisions/2026-09-25-realtime-is-the-primary-live-path-the-45.md)
...
- 2026-09-25 - [Share topics use topic_key and carry only a revision; the page refetches](decisions/2026-09-25-share-topics-use-topic-key-and-carry-only-a.md)
...
- 2026-09-25 - [The free-tier keep-alive is the usage report's Data API call, not the dump](decisions/2026-09-25-the-free-tier-keep-alive-is-the-usage.md)
...
- 2026-09-25 - [The usage history is a table in production that the nightly report writes](decisions/2026-09-25-the-usage-history-is-a-table-in-production.md)
